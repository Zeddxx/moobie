        ...
        <div className="border border-muted p-8 shadow-md rounded-md">
          ...
          {social && (
            <div className="grid grid-cols-2 mt-4 w-full gap-2">
              <TooltipContainer align="center" content="Login with google.">
              ...
              <TooltipContainer align="center" content="Login with github.">
                <Button variant="outline" className="">
          ...
          <div className="max-w-sm mx-auto mt-4 text-muted-foreground">
            <p className="text-center text-xs">
              After logging in your account it means that you are agree with all
              terms & condition required for moobie.
            </p>
          </div>
        </div>
      </div>
